              ...
              <div className="text-[#cacaca] mt-8 px-4 pb-6">
                ...
                <div className="flex flex-col md:flex-row gap-5 items-center justify-between mt-5">
                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                    <a
                      href={allProject.frontendGithub}
                      className="text-white flex items-center gap-3 border border-red-500 hover:border-white hover:text-red-500 transition-all px-6 py-2 rounded-lg"
                    >
                      Front-End
                    </a>
                    <a
                      href={allProject.backendGithub}
                      className="text-white flex items-center gap-3 border border-red-500 hover:border-white hover:text-red-500 transition-all px-6 py-2 rounded-lg"
                    >
                      Back-End
                    </a>
